...
CONF_OPTION_DEVICES = "option_devices"
CONF_OPTION_DELETE = "option_delete"
CONF_OPTION_SELECT = "option_select"
CONF_OPTIONS = [CONF_OPTION_MODIFY, CONF_OPTION_ADD]
...
CONF_TARGET = "target"
CONF_DATA_SCHEMA = vol.Schema({vol.Required(CONF_TYPE, default=None): vol.In(_KIND)})
CONF_OPTION_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_ITEM_UNIT_TYPE, default="piece"): vol.In(
            CONF_ITEM_UNIT_TYPE_KIND
        ),
