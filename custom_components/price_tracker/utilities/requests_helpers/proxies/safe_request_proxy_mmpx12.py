...
class SafeRequestProxyMmpx12(SafeRequestProxy):
    async def fetch(self):
        response_http = await RequestProxy.request(
            url="https://raw.githubusercontent.com/mmpx12/proxy-list/refs/heads/master/http.txt",
        )
        ...
        response_sock5 = await RequestProxy.request(
            url="https://raw.githubusercontent.com/mmpx12/proxy-list/refs/heads/master/socks5.txt",
        )
