...
class GsthefreshSetup(PriceTrackerSetup):
    ...
    async def setup(self, user_input: dict = None):
        ...
        if user_input is not None \
            ...
            _LOGGER.debug('GS THE FRESH Setup Validation Passed %s / %s / %s',
                          user_input[self._conf_gs_naver_login_code], user_input[self._conf_gs_store_code],
        ...
        return self._config_flow.async_show_form(
            ...
            description_placeholders={
                ...
                **self._form_i18n_description('en',
                ...
                **self._form_i18n_description('ko',
            ...
            data_schema=vol.Schema({
                **self._schema_user_input_service_type(user_input),
                vol.Required(self._conf_gs_naver_login_code, default=None): cv.string,
