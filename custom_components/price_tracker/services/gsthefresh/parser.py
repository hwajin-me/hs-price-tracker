...
class GsthefreshParser:
    ...
    def delivery(self):
        ...
        if delivery_data is not None and len(delivery_data) > 0:
            delivery_price_comm = Lu.get_item(delivery_data, "commonCode", 3)
